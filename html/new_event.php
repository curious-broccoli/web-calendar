...
<form action="create_event.php" method="post">
    ...
    Start<br />
    <input type="date" id="date_start" name="date_start" required value="<?= $next_split[0] ?>" />
    <input type="time" id="time_start" name="time_start" required value="<?= $next_split[1] ?>" /><br />
    End<br />
    <input type="date" id="date_end" name="date_end" required value="<?= $next_next_split[0] ?>" />
    <input type="time" id="time_end" name="time_end" required value="<?= $next_next_split[1] ?>" /><br />
